 ...
 */
@WebFilter({"/board/manager","/board/insert","/board/delete", "/board/update", "/category/list", "/report/list", "/category/delete", "/category/insert", "/category/update", "/admin/membermanager"})
